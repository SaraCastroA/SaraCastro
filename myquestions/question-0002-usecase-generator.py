...
def generar_caso_de_uso_vectorizar_sentencias():
    # 1. Configuración aleatoria de filas (4 a 7 registros)
    n_rows = random.randint(4, 7)

    # 2. Generación de "jerga legal" aleatoria
    ...
    # Esto convierte texto en números basados en la importancia de la palabra
    ...
    print("\n=== OUTPUT ESPERADO ===")
    print("Matriz TF-IDF (Representación numérica):")
    print(X_expected)
