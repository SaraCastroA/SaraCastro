...
def generar_caso_de_uso_agrupar_jugadores():
    ...
    # 2. Generación de datos de jugadores (goles, asistencias, etc.)
    df = pd.DataFrame({
    ...
    # 3. Procesamiento (Escalado y Clustering)
    X = df.select_dtypes(include=[np.number])

    # K-Means requiere que los datos estén en la misma escala
...
# --- LA LÍNEA QUE FALTABA PARA QUE IMPRIMA ---
